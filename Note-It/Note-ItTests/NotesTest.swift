...
class NotesTest: XCTestCase {
    ...
    func testInsertAtFirstIndex() {
        ...
        do {
            ...
            try notes.insert(note: note, atIndex : 0)
    ...
    func testInsertAtLastIndex() {
        ...
        do {
            ...
            try notes.insert(note: note, atIndex : 3)
            XCTAssertEqual(notes.count, 4)
        } catch {
            XCTFail()
        }
    ...
    func testInsertAtInvalidIndex() {
        ...
        do {
            ...
            try notes.insert(note: note, atIndex: 4)
            XCTFail()
        } catch NoteError.outOfRange(let index) {
            XCTAssertEqual(notes.count, 3)
    ...
    func testUpdateFirstIndex() {
        ...
        do {
            ...
            try notes.update(note: note, atIndex: 0)
            XCTAssertEqual(notes.count, 1)
    ...
    func testUpdateLastIndex() {
        ...
        do {
            ...
            try notes.update(note: note, atIndex: 2)
            XCTAssertEqual(notes.count, 3)
    ...
    func testUpdateInvalidIndex() {
        ...
        do {
            ...
            try notes.update(note: note, atIndex: 3)
            XCTFail()
        } catch NoteError.outOfRange(let index) {
            XCTAssertEqual(notes.count, 3)
